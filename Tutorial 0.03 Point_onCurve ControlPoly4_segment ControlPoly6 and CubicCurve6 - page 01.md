...
(all screenshots link to full size screenshots where you can clearly read the model tree, see icons, and check the DAG view to understand the object dependencies)
