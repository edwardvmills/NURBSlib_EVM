...
What does it do right now? Here is my favorite model so far. It shows control of an overall shape with 'main' sketches, and highly custumozable 'blending' of the corners of the main surfaces.
