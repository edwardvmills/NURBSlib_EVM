...
Click the arc CubicCurve_4 between its center and where the two curves meet (see picture below, the hit the Point_OnCurve macro ![Point_OnCurve](https://github.com/edwardvmills/NURBSlib_EVM/blob/master/icons/Point_OnCurve.png?raw=true)
